...
const controller = {
  ...
  get_my_products: (req: any, res: any, next: Function): void => {
    const user = getCurrentUser(req);
  ...
  patch_product: (req: any, res: any, next: Function): void => {
  ...
  post_make_payment: (req: any, res: any, next: Function): void => {
